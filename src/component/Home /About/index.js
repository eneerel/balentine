  ...
  const info = [
    {
      icon: faFlag,
      title: "Эрхэм зорилго",
      description: "Брэнд бүтээгдэхүүний сурталчилгаа, идэвхжүүлэлт, амталгаат худалдааны мэргэшсэн үйлчилгээ үзүүлэх."
    },
    {
      icon: faStar,
      title: "Давуу тал",
      description: "Туршлагатай баг, үр дүнтэй маркетингийн шийдэл, үйлчлүүлэгчдэд найдвартай үйлчилгээ."
    },
    {
      icon: faHandshake,
